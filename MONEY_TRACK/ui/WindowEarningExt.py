...
class WindowEarningExt(Ui_MainWindow):
    ...
    def clear_fields(self):
        ...
        self.radioButtonSalary.setAutoExclusive(False)
        self.radioButtonAllowance.setAutoExclusive(False)
        self.radioButtonOthers.setAutoExclusive(False)
        self.radioButtonSalary.setChecked(False)
        self.radioButtonAllowance.setChecked(False)
        self.radioButtonOthers.setChecked(False)
        self.radioButtonSalary.setAutoExclusive(True)
        self.radioButtonAllowance.setAutoExclusive(True)
    ...
    def save_transaction(self):
        ...
        if self.radioButtonSalary.isChecked():
            category_detail = "Salary"
        elif self.radioButtonAllowance.isChecked():
